    ...
    public class UnityEngineGameObjectWrap 
    {
        ...
        static int _m_SetGameObjectsActive_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<Unity.Collections.NativeArray<int>>(L, 1)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.ReadOnlySpan<int>>(L, 1)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.GameObject.SetGameObjectsActive!");
